...
function challengeStatus(state = {}) {
  if (state.phase === 'open') {
    if (state.completed) return { badge:'CONCLUÍDA', title:`Parte ${state.part} concluída`, detail:'Suas respostas estão salvas. O resultado sai no domingo.', tone:'#DFF7E8', color:'#15713A' };
  ...
  return <div style={{ position:'absolute', inset:0, zIndex:4, background:'#F3F7FC', overflowY:'auto' }}>
    ...
    <div style={{ padding:'18px 16px 32px' }}>
      ...
      <div style={{ display:'grid', gap:8, marginTop:9 }}>{[
        ['1️⃣','Parte 1 · segunda a quarta','Abre segunda-feira à 00h e termina quarta às 23h59.'],
        ['2️⃣','Parte 2 · quinta a sábado','Abre quinta-feira à 00h e termina sábado às 23h59.'],
        ['🏆','Resultado · domingo','Pontuação, ranking e correções são liberados no domingo.'],
